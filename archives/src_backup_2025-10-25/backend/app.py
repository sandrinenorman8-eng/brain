...
def fusionner_dossier():
    ...
    try:
        ...
        # Get the actual folder path from mapping
        folder_path = mapping.get(dossier, dossier)
...
def fusionner_dossier_backend():
    ...
    try:
        ...
        # Get the actual folder path from mapping
        mapped_path = mapping.get(dossier, dossier)
        
        # Construire le chemin complet du dossier
        folder_path = os.path.join(os.getcwd(), 'data', mapped_path)
